<template>
  <div id="YearKnots" class="app-container calendar-list-container">
    <el-row type="flex">
        ...
        <el-card>
          ...
          <el-form label-width="80px">
            ...
            <el-form-item label="工作状态">
              <el-col :span="23">
                <el-select v-model="state" :disabled="true" style="width:100%;">
                  <el-option
            ...
            <div class="button" style="text-align:center">
              ...
              <el-button type="primary" @click="MonthKonts" :disabled="state!=2">年度结转</el-button>
            </div>
          </el-form>
        </el-card>
...
export default {
  ...
  methods: {
    ...
    getSysTime() {
      ...
      this.temp.UpdateBy = this.$store.state.user.name;
